...
import { IllustrationContainer, StartToPlayIllustration } from '@/components/illustrations';
...
const StartToPlay = () => {
  ...
  const openRoom = useCallback(() => {
    websocket.emit.onOpenRoomToPlay({ quizUUID }, ({ confirm, player, room, message }) => {
      if (confirm) {
