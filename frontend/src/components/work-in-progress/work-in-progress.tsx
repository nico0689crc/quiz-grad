...
import { IllustrationContainer, WorkInProgressIllustration } from '@/components/illustrations';
  ...
  return (
    <Stack alignItems='center' spacing={2} justifyContent='center' flexGrow={1}>
      <IllustrationContainer
        ...
        caButton={
          <Button size='large' component={RouterLink} href={paths.home} variant='contained' color='primary'>
